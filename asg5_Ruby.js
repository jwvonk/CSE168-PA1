...
// Loaded textures
const stairTexture = new THREE.TextureLoader().load("textures/stair.jpg");
...
sides.map((side, index) => {
  mtlLoader.load("./obj/materials.mtl", (materials) => {
    materials.preload();
    const objLoader = new OBJLoader();
    objLoader.setMaterials(materials);
    objLoader.load("./obj/model.obj", (lamp) => {
...
mtlLoader.load("./obj/10073_Gazebo_V2_L3.mtl", (materials) => {
  materials.preload();
  const objLoader = new OBJLoader();
  objLoader.setMaterials(materials);
  objLoader.load("./obj/10073_Gazebo_V2_L3.obj", (gazebo) => {
...
const flareTex0 = flareLoader.load('./textures/lensflare0.png');
const flareTex3 = flareLoader.load('./textures/lensflare3.png');
